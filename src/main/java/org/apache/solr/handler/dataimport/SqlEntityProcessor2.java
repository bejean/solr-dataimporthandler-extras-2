...
public class SqlEntityProcessor2 extends EntityProcessorBase {
  ...
  protected void initQuery(String q) {
    try {
      ...
      rowIterator = (Iterator<Map<String, Object>>) dataSource.getData(q);
      this.query = q;
  ...
  public Map<String, Object> nextModifiedRowKey() {
    if (rowIterator == null) {
      ...
      if (deltaQuery == null)
          return null;
      deltaQuery = propReplace(deltaQuery);
  ...
  public Map<String, Object> nextDeletedRowKey() {
    if (rowIterator == null) {
      ...
      if (deletedPkQuery == null)
        return null;
      deletedPkQuery = propReplace(deletedPkQuery);
  ...
  public Map<String, Object> nextModifiedParentRowKey() {
    if (rowIterator == null) {
      ...
      if (parentDeltaQuery == null)
        return null;
      parentDeltaQuery = propReplace(parentDeltaQuery);
  ...
  public String getQuery() {
    ...
    queryString = propReplace(queryString);
    ...
    if (Context.DELTA_DUMP.equals(context.currentProcess())) {
      ...
      deltaImportQuery = propReplace(deltaImportQuery);
